...
export const ShoppingCartSimple: React.FC<IconProps> = ({ className = "", width = 20, height = 20, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    />
    <path
      d="M17.25 19.5C17.6642 19.5 18 19.8358 18 20.25C18 20.6642 17.6642 21 17.25 21C16.8358 21 16.5 20.6642 16.5 20.25C16.5 19.8358 16.8358 19.5 17.25 19.5Z"
      fill="white"
      stroke="white"
      strokeWidth="1.5"
    />
