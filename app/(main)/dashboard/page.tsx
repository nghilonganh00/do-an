      ...
      <div className="max-w-[1320px] mx-auto flex items-start gap-16 mt-10">
        ...
        <div className="flex-1">
          ...
          <p className="max-w-[422px] mt-3 text-body-small-400 text-gray-700">
            ...
            <span className="button text-body-small-500 text-secondary-500">Shipping and Billing Addresses</span> and
            edit your <span className="button text-body-small-500 text-secondary-500">Password </span> and{" "}
